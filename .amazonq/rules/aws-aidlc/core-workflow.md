...
# NOTE: This file contains a user-facing welcome message with workflow overview.
# Similar content exists in process-overview.md (technical reference) and README.md (documentation).
# This duplication is INTENTIONAL - each file serves a different purpose and audience.
# This file: User-facing welcome message with ASCII diagram for starting workflow
...
**CRITICAL**: When performing any phase, you MUST read and use relevant content from rule detail files in `.amazonq/aws-aidlc-rule-details/` directory.
...
**CRITICAL**: When starting ANY software development request, you MUST begin with this message:
